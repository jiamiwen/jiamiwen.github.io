...
- Recently, my passion lies in zero-knowledge proofs and the privacy-preserving cryptographic primitives derived from them, mainly based on linear algebra assumptions that conjectured quantum-resistant (e.g., Lattice, Code, and Rank).
