...
- Recently, my passion lies in zero-knowledge proofs and privacy-preserving cryptographic tools derived from them, mainly based on linear algebra assumptions conjectured to be quantum-resistant (e.g., Lattice, Code, and Rank).
