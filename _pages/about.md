...
- Recently, my passion lies in lattice-based cryptogtaphy, mainly involving zero-knowledge proofs, fully homomorphic encryption, along with cryptographic tools built upon them.
