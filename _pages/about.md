...
- Recently, my passion lies in analyzing and designing zero-knowledge protocols and signature schemes derived from them, mainly based on conjectured quantum-resistant assumptions, e.g., Lattice, Multivariate, and Code.
