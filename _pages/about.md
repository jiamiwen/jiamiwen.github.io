...
- [WWLZ23] [ACKE: Asymmetric Computing Key Exchange Protocol for IoT Environments](https://ieeexplore.ieee.org/document/10131978)
  ...
  Houzhen Wang, **Jiaming Wen***, Jinhui Liu, and Huanguo Zhang (First Author is my co-advisor & I am the Corresponding Author)
...
- [Journal of WoCrypt](https://documents.uow.edu.au/~fuchun/jow.html), a very serious fake journal about cryptography.
- [IACR ePrint Archive](https://eprint.iacr.org/), a mysterious website should be checked out every day.
...
<p style="text-align:center">Last updated: 26/07/2023 </p>
