...
# 📜 Publications
Here are publications that I am the main contributor (also, as First Author or Corresponding Author). For others, please refer to [Google Scholar](https://scholar.google.com/citations?user=IoWa4fYAAAAJ) and [DBLP](https://dblp.uni-trier.de/pid/324/5245-1.html). Roughly, they can be categorized into Post-quantum (Lattice, Multivariate) and Pre-quantum (DL).
...
<p style="text-align:center">Last updated: 10 Dec 2024 </p>
