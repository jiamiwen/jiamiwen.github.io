...
- Recently, my passion lies in analyzing and designing zero-knowledge protocols and signature schemes derived from them, mainly based on algebra assumptions that conjectured quantum-resistant (e.g., Lattice, Multivariate, and Code).
