...
<div style="display:flex; justify-content:space-between; align-items:flex-start; gap:2em; margin-bottom:2em;">
  ...
  <ul style="list-style-type:disc; padding-left:20px; margin:0;">
    ...
    <li style="margin-bottom:0.5em;">
      (Sep 2016 - Jun 2020) I earned my B.Sc. in Mathematics from Wuhan University, and continued with my graduate studies there in Sep 2020.
    </li>
  </ul>

  <p style="margin-top:1em;">
    My research interests include information security, cryptography and privacy-preserving technologies.
