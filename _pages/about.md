  ...
  <div style="display:flex; justify-content:space-between; align-items:flex-start; gap:2em; margin-bottom:2em; flex-wrap:nowrap;">
    ...
    <div style="flex:0 0 70%;">
      ...
      <ul style="padding-left:20px; line-height:1.7;">
        ...
        <li>
          (Jun 2025 - Aug 2025) I did an algorithm internship at
      ...
      <p>
        I work on information security (cryptography, privacy-preserving technologies, AI × security), as well as their overlap with education (educational data security and governance, information security education).
      </p>
